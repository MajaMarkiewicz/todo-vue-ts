...
export type Mutations<S = State> = {
  [MutationType.CreateTask](state: S, task: TaskItem): void
  [MutationType.SetTasks](state: S, tasks: TaskItem[]): void
  ...
  [MutationType.SetEditModal](state: S, value: {showModal: boolean, taskId: number|undefined}): void
  [MutationType.SetTaskModal](state: S, value: {showModal: boolean, taskId: number|undefined}): void
}
